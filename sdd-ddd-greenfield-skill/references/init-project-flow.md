...
Read from `sdd-ddd-greenfield-skill/scaffolding/` and compute the
destination path:
...
- Scaffolding templates: `sdd-ddd-greenfield-skill/scaffolding/`
- `_index.md` feature template: `sdd-ddd-greenfield-skill/templates/_index.md`
  (used by `/dflow:new-feature`, NOT by this flow)
- Git integration rules: `sdd-ddd-greenfield-skill/references/git-integration.md`
