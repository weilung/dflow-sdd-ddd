...
| Project AI guide | `<project root>/CLAUDE.md` | `templates/CLAUDE.md` | `templates/CLAUDE.md` | H2 navigation and H3 structural headings aligned (canonical English, per F-01 Path A); special root-level exception outside `dflow/specs/` so AI tools can discover it | Greenfield includes Aggregate / Architecture Decisions and other Greenfield-specific H3 sections | - |
