# Tutorial 劇情 2（Brownfield）— OrderManager 與 Bob
...
baseline outputs 位於 [`tutorial/02-brownfield/outputs/`](outputs/)。這些檔案模擬 Bob 在 OrderManager 裡完成 `npx dflow-sdd-ddd init` 後的結果。
