...
- file-list preview 如何在寫檔前建立 phase gate
...
Alice 已經完成 [〈Walkthrough 00 — Greenfield setup：Alice / ExpenseTracker 的起點〉](walkthrough-00-setup.zh-TW.md) 的準備：
...
## Step 3 — File-list preview 是 init 的 phase gate
...
[〈Walkthrough 02 — `/dflow:new-feature` 建立第一個 Expense feature〉](walkthrough-02-new-feature.zh-TW.md) 才正式建立
...
→ [〈Walkthrough 02 — `/dflow:new-feature` 建立第一個 Expense feature〉](walkthrough-02-new-feature.zh-TW.md)：Alice
