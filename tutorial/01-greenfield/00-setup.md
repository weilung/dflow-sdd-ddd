# Tutorial 劇情 1（Greenfield）— ExpenseTracker 與 Alice
...
Greenfield outputs 位於 [`tutorial/01-greenfield/outputs/`](outputs/)。這些檔案模擬 Alice 跑完 init、new-feature、new-phase、modify-existing、bug-fix 與 finish-feature 後的 Dflow docs。
