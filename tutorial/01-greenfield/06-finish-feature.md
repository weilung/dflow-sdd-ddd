...
>
> 這個 tutorial repo 的 outputs 是示範 fixture；我會在 `tutorial/01-greenfield/outputs/...` 底下用 OS-level move 模擬 archive。但規範要記住：真實專案中的 `dflow/specs/features/active/...` → `dflow/specs/features/completed/...` 應該用 `git mv`。
>
...
→ 劇情 2：[`../02-brownfield/00-setup.md`](../02-brownfield/00-setup.md)
