...
`npx dflow-sdd-ddd init`、`dflow doctor`、`/dflow:new-feature`、
...
| 層級 | 形式 | 在哪裡執行 | 用途 |
|---|---|---|---|
| npm CLI | `npx dflow-sdd-ddd init`、`dflow doctor`、`dflow configure-agents` | shell / terminal | 建立或檢查 Dflow workspace 與 AI tool shim。 |
...
```text
1. 在 shell 執行 npx dflow-sdd-ddd init
...
Greenfield 範例可看：
[01-greenfield/01-init-project.md](01-greenfield/01-init-project.md)

Brownfield 範例可看：
[02-brownfield/01-init-project.md](02-brownfield/01-init-project.md)
...
- [02-brownfield/02-modify-existing.md](02-brownfield/02-modify-existing.md)
...
- [01-greenfield/03-new-phase.md](01-greenfield/03-new-phase.md)
...
- [01-greenfield/06-finish-feature.md](01-greenfield/06-finish-feature.md)

Brownfield closeout 範例：

- [02-brownfield/06-finish-feature.md](02-brownfield/06-finish-feature.md)
...
1. 本頁：先理解命令表面。
2. [01-greenfield/00-setup.md](01-greenfield/00-setup.md)：理解 Alice / ExpenseTracker。
3. [01-greenfield/01-init-project.md](01-greenfield/01-init-project.md)：看 CLI init 如何建立 baseline。
...
1. [02-brownfield/00-setup.md](02-brownfield/00-setup.md)
2. [02-brownfield/01-init-project.md](02-brownfield/01-init-project.md)
3. [02-brownfield/02-modify-existing.md](02-brownfield/02-modify-existing.md)

## Key takeaways

- `npx dflow-sdd-ddd init` 是 shell CLI；`/dflow:*` 是 AI workflow。
