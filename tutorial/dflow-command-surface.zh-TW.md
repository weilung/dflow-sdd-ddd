...
| 層級 | 形式 | 在哪裡執行 | 用途 |
|---|---|---|---|
| npm CLI | `dflow init`、`dflow doctor`、`dflow configure-agents` | shell / terminal | 建立或檢查 Dflow workspace 與 AI tool shim。 |
...
| 擔心 AI 一路自動做下去 | 本頁說明 `/dflow:next`、phase gate、`/dflow:cancel` 的控制角色。 |
...
再用 /dflow:* 讓 AI coding agent 依 workflow 做事。
```
...
4. 依任務輸入 /dflow:new-feature、/dflow:modify-existing、/dflow:bug-fix 等
5. 在 phase gate 用 /dflow:next 或自然語言確認是否繼續
```
...
Greenfield 範例可看：
[〈Walkthrough 01 — `dflow init` 建立 Greenfield baseline〉](01-greenfield/walkthrough-01-init-project.zh-TW.md)

Brownfield 範例可看：
[〈Walkthrough 01 — `dflow init` 建立 Brownfield baseline〉](02-brownfield/walkthrough-01-init-project.zh-TW.md)
...
如果你的 AI 工具不支援真正的 slash command，也可以把同樣文字當作普通訊息輸入，例如：
...
- [01-greenfield/walkthrough-03-new-phase.zh-TW.md](01-greenfield/walkthrough-03-new-phase.zh-TW.md)

`/dflow:new-phase` 的重點是：它不是開一個 unrelated new feature，而是在同一個
active feature directory 內新增 phase spec，並繼承 / 更新 Current BR Snapshot。
...
- [01-greenfield/walkthrough-06-finish-feature.zh-TW.md](01-greenfield/walkthrough-06-finish-feature.zh-TW.md)

Brownfield closeout 範例：

- [02-brownfield/walkthrough-06-finish-feature.zh-TW.md](02-brownfield/walkthrough-06-finish-feature.zh-TW.md)
...
| active feature 還在進行中，需要下一個 phase | `/dflow:new-phase` |
...
1. 本頁：先理解命令表面。
2. [01-greenfield/walkthrough-00-setup.zh-TW.md](01-greenfield/walkthrough-00-setup.zh-TW.md)：理解 Alice / ExpenseTracker。
3. [01-greenfield/walkthrough-01-init-project.zh-TW.md](01-greenfield/walkthrough-01-init-project.zh-TW.md)：看 CLI init 如何建立 baseline。
4. [01-greenfield/walkthrough-02-new-feature.zh-TW.md](01-greenfield/walkthrough-02-new-feature.zh-TW.md)：看第一個 feature 如何從對話變成 spec 與 DDD 文件。

如果你維護的是既有系統，再接著讀：

1. [02-brownfield/walkthrough-00-setup.zh-TW.md](02-brownfield/walkthrough-00-setup.zh-TW.md)
2. [02-brownfield/walkthrough-01-init-project.zh-TW.md](02-brownfield/walkthrough-01-init-project.zh-TW.md)
3. [02-brownfield/walkthrough-02-modify-existing.zh-TW.md](02-brownfield/walkthrough-02-modify-existing.zh-TW.md)
...
- `/dflow:new-phase` 只適用 active feature 的下一個 phase。
...
- 如果 AI tool 不支援 slash command UI，可以把同樣 command name 當作普通對話指令。
